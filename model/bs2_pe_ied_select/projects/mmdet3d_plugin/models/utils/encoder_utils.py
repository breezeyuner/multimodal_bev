...
class BEVWarp(nn.Module):
    ...
    def forward(self, lidar_feats, img_feats, img_metas, pts_metas, **kwargs):
        ...
        xyz_bevs = torch.stack(xyz_bevs, dim=0)  #batch_size , [6, 112, 200, 2]
...
class MMRI_P2I(nn.Module):
    ...
    def forward(self, lidar_feats, img_feats, img_metas, pts_metas, **kwargs):
        warped_img_feats,xy_bevs = self.Warp(lidar_feats, img_feats, img_metas, pts_metas) #warped_img_feats: B, N, C, H, W
        ...
        return decorated_img_feats, xy_bevs # xy_bevs : B, N, H, W, 2 , corresponding position in BEV
