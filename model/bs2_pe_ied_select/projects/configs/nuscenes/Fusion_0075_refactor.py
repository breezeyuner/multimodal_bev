...
data_root = '/root/v1.0-mini-100v/'  #'/root/v1.0-mini-5p/'#'/root/v1.0-mini/'#'/root/autodl-tmp/v1.0-mini/'
input_modality = dict(
    use_lidar=True,
    use_camera=True,
    use_radar=False,
...
log_level = 'INFO'
work_dir = None
load_from = '/root/r50_fpn_voxel_0075.pth'#'/root/autodl-tmp/r50_fpn_voxel_0075.pth'
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 8)
