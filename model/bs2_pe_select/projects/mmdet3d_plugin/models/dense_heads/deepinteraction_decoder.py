...
class DeepInteractionDecoder(nn.Module):
    ...
    def forward(self, pts_inputs, img_inputs, img_metas, P_bev_pos, I_bev_pos,):
        ...
        #I_bev_pos_flatten torch.Size([1, 6, 22400, 3])
        ...
        #image feat + image PE 
        img_feat_flatten = img_feat_flatten + I_bev_pos_feat_flatten
        ...
        new_lidar_feat = new_lidar_feat + P_bev_pos_feat
        ...
        for layer_idx in range(self.num_mmpi):
            ...
            query_feat, on_the_image = self.decode_head[layer_idx](
                query_feat=prev_query_feat, #+ query_pos_feat,  #prev_query_feat + query emb 
                res_layer=res_layer, 
