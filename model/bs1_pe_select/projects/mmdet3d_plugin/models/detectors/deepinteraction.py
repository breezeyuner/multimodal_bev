...
class DeepInteraction(MVXTwoStageDetector):
    ...
    def extract_feat(self, points, img, img_metas):
        ...
        new_img_feat, new_pts_feat, I_bev_pos, P_bev_pos = self.imgpts_neck(img_feats[0], pts_feats[0], img_metas, pts_metas)
    ...
    def forward_pts_train(self,
        ...
        """
        outs = self.pts_bbox_head(pts_feats, img_feats, img_metas,P_bev_pos, I_bev_pos,)  #decoder 
