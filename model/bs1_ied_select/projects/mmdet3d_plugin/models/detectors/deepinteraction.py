...
class DeepInteraction(MVXTwoStageDetector):
    ...
    def extract_feat(self, points, img, img_metas):
        ...
        new_img_feat, new_pts_feat, I_bev_pos, P_bev_pos = self.imgpts_neck(img_feats[0], pts_feats[0], img_metas, pts_metas) #DeepInteractionEncoder
        return (new_img_feat, new_pts_feat,I_bev_pos, P_bev_pos)
    ...
    def forward_train(self,
        ...
        """
        img_feats, pts_feats,I_bev_pos, P_bev_pos = self.extract_feat(
    ...
    def forward_pts_train(self,
        ...
        """
        outs = self.pts_bbox_head(pts_feats, img_feats, img_metas,P_bev_pos, I_bev_pos,)  #DeepInteractionDecoder 
        loss_inputs = [gt_bboxes_3d, gt_labels_3d, outs]
        losses = self.pts_bbox_head.loss(*loss_inputs)
        return losses

    def simple_test_pts(self, x, x_img, img_metas,P_bev_pos, I_bev_pos, rescale=False):
        """Test function of point cloud branch."""
        outs = self.pts_bbox_head(x, x_img, img_metas,P_bev_pos, I_bev_pos)
    ...
    def simple_test(self, points, img_metas, img=None, rescale=False):
        ...
        bbox_pts = self.simple_test_pts(
            pts_feats, img_feats, img_metas,P_bev_pos ,I_bev_pos, rescale=rescale)
